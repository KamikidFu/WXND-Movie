SET @IMAGE_BASE_URL = "https://weapp-movie-1257331045.cos.ap-chengdu.myqcloud.com/images/"; 
...
CREATE TABLE `comment` (
  ...
  `voice` varchar(1024) DEFAULT NULL,
  PRIMARY KEY(`id`),
  KEY(`movie_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO comment (`id`, `movie_id`, `comment_type`, `user`, `username`, `avatar`, `content`,`voice`) VALUES (1,1,0,'USER_AAA','USER_AAA',CONCAT(@IMAGE_BASE_URL,'user_s.png'),'这是一部好电影！',''),(2,3,0,'USER_BBB','USER_BBB',CONCAT(@IMAGE_BASE_URL,'user_s.png'),'特别好看！',''),(3,3,0,'USER_CCC','USER_CCC',CONCAT(@IMAGE_BASE_URL,'user_s.png'),'感觉一般！','');

INSERT INTO favor(`id`,`commentId`,`user`,`username`) VALUES (1,3,'USER_AAA','USER_AAA');

INSERT INTO publish (`id`,`commentId`,`user`,`username`) VALUES(1,1,'USER_AAA','USER_AAA');